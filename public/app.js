...
},{"../core/createError":9,"./../core/settle":12,"./../helpers/btoa":16,"./../helpers/buildURL":17,"./../helpers/cookies":19,"./../helpers/isURLSameOrigin":21,"./../helpers/parseHeaders":23,"./../utils":25,"_process":357}],3:[function(require,module,exports){
'use strict';
...
},{"./adapters/http":2,"./adapters/xhr":2,"./helpers/normalizeHeaderName":22,"./utils":25,"_process":357}],15:[function(require,module,exports){
'use strict';
...
},{"./helpers/bind":15,"is-buffer":350}],26:[function(require,module,exports){
(function (global){
"use strict";
...
},{"core-js/fn/regexp/escape":30,"core-js/shim":323,"regenerator-runtime/runtime":358}],27:[function(require,module,exports){
...
},{"global/document":325,"hyperx":328,"on-load":354}],28:[function(require,module,exports){
...
},{"./lib/core.js":347,"./locale-data/complete.js":28}],347:[function(require,module,exports){
(function (global){
'use strict';
...
},{"global/document":325,"global/window":326}],355:[function(require,module,exports){
(function (process){
...
},{"_process":357,"path-to-regexp":356}],356:[function(require,module,exports){
...
},{"isarray":351}],357:[function(require,module,exports){
...
},{"./is-function":360,"./is-object":361,"./request-base":362,"./response-base":363,"./should-retry":364,"component-emitter":29}],360:[function(require,module,exports){
/**
...
},{"./update-events.js":369,"bel":27,"morphdom":353}],369:[function(require,module,exports){
module.exports = [
...
var elem = yo(_templateObject, translate.message('logout'));

//ponernos en el header container este elemento
module.exports = function header(ctx, next) {
    var container = document.getElementById('header-container');
    empty(container).appendChild(elem);
    next();
};

},{"../translate":384,"empty-element":324,"yo-yo":368}],372:[function(require,module,exports){
'use strict';
        ...
        while (1) {
            switch (_context.prev = _context.next) {
                case 0:
                    _context.prev = 0;
                    _context.next = 3;
                    return regeneratorRuntime.awrap(fetch('/api/pictures')
...
},{"../header":371,"../picture-card":377,"./template":373,"axios":1,"empty-element":324,"page":355,"superagent":359,"title":366,"webcamjs":367}],373:[function(require,module,exports){
'use strict';
...
module.exports = function (pictures) {
    var elem = yo(_templateObject, onsubmit, translate('upload-picture'), onchange, translate('upload'), cancel, pictures.map(function (pic) {
        return picture(pic);
    }));
...
},{"../layout":376,"../picture-card":377,"../translate":384,"superagent":359,"yo-yo":368}],374:[function(require,module,exports){
'use strict';
...
},{"./footer":370,"./homepage":372,"./signin":378,"./signup":380,"./user-page":385,"babel-polyfill":26,"page":355}],375:[function(require,module,exports){
'use strict';
...
},{"yo-yo":368}],376:[function(require,module,exports){
'use strict';
...
},{"../translate":384,"yo-yo":368}],377:[function(require,module,exports){
'use strict';
...
},{"../translate":384,"moment":352,"yo-yo":368}],378:[function(require,module,exports){
'use strict';
...
},{"./template":379,"empty-element":324,"page":355,"title":366}],379:[function(require,module,exports){
'use strict';
...
},{"../landing/index.js":375,"../translate":384,"yo-yo":368}],380:[function(require,module,exports){
'use strict';
...
},{"./template":381,"empty-element":324,"page":355,"title":366}],381:[function(require,module,exports){
'use strict';
...
},{"../landing/index.js":375,"../translate":384,"yo-yo":368}],382:[function(require,module,exports){
'use strict';
...
module.exports = {
        ...
        'english': 'English',
        'spanish': 'Spanish',
        'signup.subheading': 'Signup to watch your friends\' pictures studying at SENA',
        'signup.facebook': 'Signup with Faceebook',
        'signup.text': 'Signup',
        'email': 'Email',
        'username': 'Username',
        'fullname': 'Fullname',
...
//module.exports es para poder requerir el archivo es en otro archivo
//estos son clave : valor
module.exports = {
    'likes': '{likes, number } me gusta',
    'logout': 'Salir',
    'english': 'Ingles',
    'spanish': 'Español',
    'signup.subheading': 'Registrate para ver fotos de tus amigos estudiando en el SENA',
    'signup.facebook': 'Iniciar seccion con facebook',
    'signup.text': 'Iniciar secion',
...
},{"./en-US":382,"./es":383,"intl":346,"intl-messageformat":331,"intl-relativeformat":340,"intl-relativeformat/dist/locale-data/en.js":338,"intl-relativeformat/dist/locale-data/es.js":339,"intl/locale-data/jsonp/en-US.js":348,"intl/locale-data/jsonp/es.js":349}],385:[function(require,module,exports){
'use strict';
...
(0, _page2.default)('/:username', _header2.default, loadUser, function (ctx, next) {
    ...
    (0, _title2.default)('Senagram - ' + ctx.params.username);
    //appendChild:convierte el en hijo de main main es el contenedor y dentro del contenedor va el
    //empty: vacia el contenido de main y despues  ingresa el contendido de el template dentro de main 
...
(0, _page2.default)('/:username/:id', _header2.default, loadUser, function (ctx, next) {
    ...
    $('.modal').modal({
        complete: function complete() {
            (0, _page2.default)('/' + ctx.user.username);
        }
    });
        ...
        while (1) {
            switch (_context.prev = _context.next) {
                case 0:
                    _context.prev = 0;
                    _context.next = 3;
                    return regeneratorRuntime.awrap(fetch('api/user/' + ctx.params.username)
...
},{"../header":371,"./template":386,"empty-element":324,"page":355,"title":366}],386:[function(require,module,exports){
'use strict';
...
function userPageTemplate(user) {
    var el = (0, _yoYo2.default)(_templateObject, user.avatar, user.username, user.username, user.pictures.map(function (picture) {
        return (0, _yoYo2.default)(_templateObject2, user.username, picture.id, picture.likes, picture.src, picture.id, picture.src, _translate2.default.message('likes', { likes: picture.likes }));
    }));

    return (0, _layout2.default)(el);
}

},{"../layout":376,"../translate":384,"yo-yo":368}]},{},[374]);
